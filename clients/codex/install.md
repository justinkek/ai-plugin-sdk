...
In the command line, run `/hooks`, read the {{hooks}} commands and trust each one.
...
Plugin, and turn on the Trust switch beside each of the {{hooks}}. Then quit the app
